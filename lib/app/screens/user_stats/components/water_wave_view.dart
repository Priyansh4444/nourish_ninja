        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: NourishNinjaTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      NourishNinjaTheme.nearlyDarkBlue.withOpacity(0.2),
                      NourishNinjaTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: NourishNinjaTheme.nearlyDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      NourishNinjaTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: NourishNinjaTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: NourishNinjaTheme.white.withOpacity(
